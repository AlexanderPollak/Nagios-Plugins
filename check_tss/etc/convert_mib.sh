...
python3  ../lib/mibdump.py  --mib-source="file:///usr/local/lib/python3.10/dist-packages/pysnmp/smi/mibs" --destination-directory="/usr/local/pump-monitor/etc" --destination-format=pysnmp  /usr/share/snmp/mibs/ROOMALERT32S.MIB

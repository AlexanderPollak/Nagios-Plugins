...
def control(SNMP_Host, SNMP_Version, SNMP_Community, SNMP_Port, SNMP_Device, T_Sensor_C_1, T_Sensor_C_2, T_Sensor_C_3, N_Sensors, Shutdown_Temperature, Shutdown_Message, Host_Names_Level_1):
